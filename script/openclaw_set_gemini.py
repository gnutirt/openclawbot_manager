...
def run_set_gemini_command():
    ...
    try:
        ...
        # 2. Lọc chỉ lấy models của service google-antigravity
        google_models = [m for m in all_models if m.get("service") == "google-antigravity"]
        
        if not google_models:
            print("❌ Lỗi: Không tìm thấy model nào của service google-antigravity.")
            return
        
        # 3. Chọn ngẫu nhiên 1 model từ google-antigravity
        selected_model = random.choice(google_models)
        ...
        print(f"📦 Service: google-antigravity | Model: {model_name}")
        ...
        msg = (
            ...
            f"<b>Service:</b> <code>google-antigravity</code>\n"
